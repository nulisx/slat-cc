...
import type { WheelSegment } from '@/lib/casino/spin-the-wheel/schemas'
  ...
  return (
    <div className="relative mt-6 rounded-full border-2 border-neutral-100 bg-neutral-200 p-1 drop-shadow-[0px_0px_8px_rgba(255,255,255,0.5)]">
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/2 z-10 grid size-[44px] -translate-x-1/2 -translate-y-1/2 place-content-center rounded-full border-2 border-neutral-200 bg-neutral-100">
