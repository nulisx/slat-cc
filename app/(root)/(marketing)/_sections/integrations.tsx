...
import { SiDiscord, SiGithub, SiRoblox, SiSoundcloud, SiSpotify, SiSteam, SiTwitch, SiYoutube } from 'react-icons/si'
...
export function Integrations() {
  return (
    ...
    >
      ...
      <div className="grid w-fit grid-cols-4 grid-rows-2 gap-4">
